...
#             # st.write("Merged Data (after removing duplicates):")
#             # st.dataframe(merged_df)
            
#             # # Calculate minimum price in USD from merged data
#             # min_price = merged_df['Price in USD'].min()
            
#             # # Display minimum price
#             # st.write("Minimum Price (USD):", min_price)
            
#             # # # Print entire row of minimum price
#             # # min_row = merged_df[merged_df['Price in USD'] == min_price]
#             # # st.sidebar.dataframe(min_row)  # Display min_row in the sidebar
...
#                 # # Print entire row of minimum price
#                 min_row = filtered_df[filtered_df['Price in USD'] == min_price]
#                 st.header("Minimum price in USD")
#                 st.dataframe(min_row)  # Display min_row in the sidebar
...
#                 # # # Print entire row of minimum price
#                 # min_row = filtered_df[filtered_df['Price in USD'] == min_price]
#                 # st.sidebar.header("Minimum price in USD")
#                 # st.sidebar.dataframe(min_row)  # Display min_row in the sidebar
